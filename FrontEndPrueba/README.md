...
5. Ejecutar el comanto "npm i" , para realizar la descarga y actualizacion de todas las dependencias del proyecto
6. Verificar que el API (Back End) este conectado y en ejecucion.
